...
| `lina-dish-steak-pap-working-v1-20260802.webp` | Derived from `Stake_nePapa.png` (ffmpeg, scale=800:-1, libwebp q82) | WebP, 800×800, RGBA (yuva420p, alpha confirmed) | Produced, not deployed (not allowlisted in `.vercelignore`) | — | ~68KB. Original untouched. Built for the D-025 numbered-index homepage direction, since superseded by D-026's split editorial hero — held in reserve rather than deleted. |
| `lina-dish-tripe-dumpling-working-v1-20260802.webp` | Derived from `Ulusu_nedombolo.png` | WebP, 800×800, RGBA | Produced, not deployed (not allowlisted in `.vercelignore`) | — | ~47KB. Original untouched. Same D-025/D-026 note as above. |
| `lina-dish-catering-bowl-working-v1-20260802.webp` | Derived from `Checkin.png` | WebP, 800×800, RGBA | Produced, not deployed (not allowlisted in `.vercelignore`) | — | ~63KB. Original untouched. Same D-025/D-026 note as above. |
| `lina-dish-rice-working-v1-20260802.webp` | Derived from `Rice.png` | WebP, 800×800, RGBA | Produced, not deployed (not allowlisted in `.vercelignore`) | — | Best single cutout in the batch; held in reserve for a future menu-page or gallery use. |
...
`lina-hero-chef-cutout-working-v1-20260802.webp` | Derived from `Lina's_Welcome.png` (ffmpeg, scale=900:-1, libwebp q90) | WebP, 900×1200, RGBA (`yuva420p`, alpha confirmed) | Superseded — no longer referenced, `.vercelignore` line removed | — | ~73KB. Original untouched. Was the homepage hero visual under D-027; replaced by the file below under D-028. File kept on disk, not deleted.
